...
class ResNet(ImageClassificationBase):
    def __init__(self):
        ...
        self.network = models.resnet50(pretrained=True) # using ResNet50 pretrained model for image classification
        # Replace last layer
...
# Porting to GPU for computation
